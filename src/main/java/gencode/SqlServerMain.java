...
/*		System.err.print("输入3才能生成生成代码，确定生成请输入:");
		...
		// mysql mysql mysql
		String dbtype = "sqlserver";// mysql
		String driver = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
		String url = "jdbc:sqlserver://10.1.0.13:1433;DatabaseName=scm_main;";
		String username = "sa";
		String pwd = "123456";
		String scheme = "scm_main";
		// 测试的链接
		// ===========================================================================
		// 要生成的表
		String tname = "add_gly";
		// ============================================================================
		...
		BeanModel bm = bs.getBeanModel(driver, url, username, pwd, tname,
				scheme);
		// 基本路径
		String clspath = "com\\weds\\queryplatform\\search\\";
